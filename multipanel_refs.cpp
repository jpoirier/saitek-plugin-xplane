...
// that can be found in the LICENSE file.
    ...
    /* buttons */
    gMpApToggleCmdRef       = XPLMFindCommand(sFDIR_SERVOS_TOGGLE);
...
//    gMpAltDataRef             = XPLMFindDataRef(sALTITUDE_HOLD_FT);
    ...
    gMpApOnDataRef            = XPLMFindDataRef(sAUTOPILOT_ON);
    ...
    XPLMRegisterCommandHandler(cmd_ref, MultiPanelCommandHandler, CMD_HNDLR_EPILOG, (void*)CMD_OTTO_ALT_DN);

    cmd_ref = XPLMCreateCommand(sALTITUDE_UP, "AutoPilot ALT Up");
    XPLMRegisterCommandHandler(cmd_ref, MultiPanelCommandHandler, CMD_HNDLR_EPILOG, (void*)CMD_OTTO_ALT_UP);

    cmd_ref = XPLMCreateCommand(sVERTICAL_SPEED_DOWN, "AutoPilot VS Down");
    XPLMRegisterCommandHandler(cmd_ref, MultiPanelCommandHandler, CMD_HNDLR_EPILOG, (void*)CMD_OTTO_VS_DN);

    cmd_ref = XPLMCreateCommand(sVERTICAL_SPEED_UP, "AutoPilot VS Up");
    XPLMRegisterCommandHandler(cmd_ref, MultiPanelCommandHandler, CMD_HNDLR_EPILOG, (void*)CMD_OTTO_VS_UP);

    cmd_ref = XPLMCreateCommand(sAIRSPEED_DOWN, "AutoPilot IAS Down");
    XPLMRegisterCommandHandler(cmd_ref, MultiPanelCommandHandler, CMD_HNDLR_EPILOG, (void*)CMD_OTTO_IAS_DN);

    cmd_ref = XPLMCreateCommand(sAIRSPEED_UP, "AutoPilot IAS Up");
    XPLMRegisterCommandHandler(cmd_ref, MultiPanelCommandHandler, CMD_HNDLR_EPILOG, (void*)CMD_OTTO_IAS_UP);

    cmd_ref = XPLMCreateCommand(sHEADING_DOWN, "AutoPilot HDG Down");
    XPLMRegisterCommandHandler(cmd_ref, MultiPanelCommandHandler, CMD_HNDLR_EPILOG, (void*)CMD_OTTO_HDG_DN);

    cmd_ref = XPLMCreateCommand(sHEADING_UP, "AutoPilot HDG Up");
    XPLMRegisterCommandHandler(cmd_ref, MultiPanelCommandHandler, CMD_HNDLR_EPILOG, (void*)CMD_OTTO_HDG_UP);

    cmd_ref = XPLMCreateCommand(sOBS_HSI_DOWN, "AutoPilot CRS Down");
    XPLMRegisterCommandHandler(cmd_ref, MultiPanelCommandHandler, CMD_HNDLR_EPILOG, (void*)CMD_OTTO_CRS_DN);

    cmd_ref = XPLMCreateCommand(sOBS_HSI_UP, "AutoPilot CRS Up");
    XPLMRegisterCommandHandler(cmd_ref, MultiPanelCommandHandler, CMD_HNDLR_EPILOG, (void*)CMD_OTTO_CRS_UP);

    /* buttons */
// XXX: are the autopilt
    cmd_ref = XPLMCreateCommand(sFLIGHT_DIR_ON_ONLY, "AutoPilot Armed");
    XPLMRegisterCommandHandler(cmd_ref, MultiPanelCommandHandler, CMD_HNDLR_EPILOG, (void*)CMD_OTTO_ARMED);

    cmd_ref = XPLMCreateCommand(sSERVOS_AND_FLIGHT_DIR_ON, "AutoPilot On");
    XPLMRegisterCommandHandler(cmd_ref, MultiPanelCommandHandler, CMD_HNDLR_EPILOG, (void*)CMD_OTTO_ON);

    cmd_ref = XPLMCreateCommand(sSERVOS_AND_FLIGHT_DIR_OFF, "AutoPilot Off");
    XPLMRegisterCommandHandler(cmd_ref, MultiPanelCommandHandler, CMD_HNDLR_EPILOG, (void*)CMD_OTTO_OFF);

    cmd_ref = XPLMCreateCommand(sALTITUDE_ARM, "AutoPilot HDG");
    XPLMRegisterCommandHandler(cmd_ref, MultiPanelCommandHandler, CMD_HNDLR_EPILOG, (void*)CMD_OTTO_HDG_BTN);

    cmd_ref = XPLMCreateCommand(sNAV, "AutoPilot NAV");
    XPLMRegisterCommandHandler(cmd_ref, MultiPanelCommandHandler, CMD_HNDLR_EPILOG, (void*)CMD_OTTO_NAV_BTN);

    cmd_ref = XPLMCreateCommand(sLEVEL_CHANGE, "AutoPilot IAS");
    XPLMRegisterCommandHandler(cmd_ref, MultiPanelCommandHandler, CMD_HNDLR_EPILOG, (void*)CMD_OTTO_IAS_BTN);

    cmd_ref = XPLMCreateCommand(sALTITUDE_HOLD, "AutoPilot ALT");
    XPLMRegisterCommandHandler(cmd_ref, MultiPanelCommandHandler, CMD_HNDLR_EPILOG, (void*)CMD_OTTO_ALT_BTN);

    cmd_ref = XPLMCreateCommand(sVERTICAL_SPEED, "AutoPilot VS");
    XPLMRegisterCommandHandler(cmd_ref, MultiPanelCommandHandler, CMD_HNDLR_EPILOG, (void*)CMD_OTTO_VS_BTN);

    cmd_ref = XPLMCreateCommand(sAPPROACH, "AutoPilot APR");
    XPLMRegisterCommandHandler(cmd_ref, MultiPanelCommandHandler, CMD_HNDLR_EPILOG, (void*)CMD_OTTO_APR_BTN);

    cmd_ref = XPLMCreateCommand(sBACK_COURSE, "AutoPilot REV");
    XPLMRegisterCommandHandler(cmd_ref, MultiPanelCommandHandler, CMD_HNDLR_EPILOG, (void*)CMD_OTTO_REV_BTN);
